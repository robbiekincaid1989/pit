            ...
            <div class="dark:bg-black bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 dark:bg-gray-800 bg-white dark:text-gray-100 text-black">
                    ...
                    <form method="POST" action="{{ route('newsposts.store') }}">
                        ...
                        Title:
                        <br>
                        <input class="w-full rounded-md shadow-sm border-gray-300 dark:text-gray-200 dark:bg-gray-900" type="text" name="title">
                        <br>
                        <br>
                        Content:
                        <br>
                        <textarea style="resize: none" class="w-full rounded-md shadow-sm border-gray-300 dark:text-gray-200 dark:bg-gray-900" type="text" name="content" rows="30"></textarea>
                        <br>
                        <br>
                        Category:
                        <br>
